...
def update_status(csv_file, check_file):
    ...
    common_values_col2 = values_to_check_col2.intersection(values_to_compare_col2)
    ...
    output_file_path = os.path.join(output_dir, "WestJet-CityPairs-Q2-2024-dom-lac.csv")
