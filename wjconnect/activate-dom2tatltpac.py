...
def update_status(csv_file, check_file):
    ...
    # Find common values in column 1 of the main file and the check file
    common_values_col1 = values_to_check_col1.intersection(values_to_compare_col1)
    ...
    # Check if values in column 2 of the main file exist in column 2 of the check file
    common_values_col2 = values_to_check_col2.intersection(values_to_compare_col4)
    ...
    output_file_path = os.path.join(output_dir, "WestJet-CityPairs-Q2-2024-dom-tatltpac.csv")
